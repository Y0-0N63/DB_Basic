...
CREATE USER kh_cby IDENTIFIED BY kh1234;
-- SQL Error [65096] [99999]: ORA-65096: 공통 사용자 또는 롤 이름이 부적합합니다.
-- 11G 이전 문법 사용 허용으로 해결할 수 있음
-- SQL Error [1920] [42000]: ORA-01920: 사용자명 'KH_CBY'(이)가 다른 사용자나 롤 이름과 상충됩니다

-- 사용자 계정에 권한 부여
GRANT RESOURCE, CONNECT TO kh_cby;

-- 객체가 생성될 수 있는 공간 할당량 무제한 지정
ALTER USER kh_cby DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;