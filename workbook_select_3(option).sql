-- 1. 학생 이름과 주소지를 표시하시오.
-- 단, 출력 헤더는 '학생 이름', '주소지'로 하고 정렬은 이름으로 오름차순으로 표시하도록 한다.
SELECT STUDENT_NAME AS "학생 이름", STUDENT_ADDRESS 주소지 FROM TB_STUDENT;
...
-- 3. 주소지가 강원도나 경기도인 학생들 중 1900년대 학번을 가진 학생들의 이름과 학번, 주소를 표시하시오.
-- 단, 출력헤더에는 '학생이름', '학번', '거주지 주소'로 하고 정렬은 이름으로 오름차순으로 표시하도록 한다.
...
SELECT STUDENT_NO, TO_CHAR(POINT, '0.00') FROM TB_GRADE
